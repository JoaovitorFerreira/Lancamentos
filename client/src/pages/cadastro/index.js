...
export default function Cadastro(props) {
  ...
  useEffect(() => {
    const loadTransaction = async () => {
      ...
      const { data: transaction } = await api.get(
        `/api/transaction/byId/${props.match.params.id}`
      );
      if (transaction) {
        const {
          _id,
        ...
        <InnerContent>
          {isLoading ? (
            ...
            <Form onSubmit={handleSubmit}>
              ...
              <InputField
                isErrored={isErrored["description"]}
                label="Descrição"
                value={description}
              ...
              />
              <InputField
                min={moment(props.match.params.period)
                  .startOf("month")
                  .format("YYYY-MM-DD")}
                max={moment(props.match.params.period)
                  .endOf("month")
                  .format("YYYY-MM-DD")}
              ...
              <Buttons>
                {isSaving ? (
                  ...
                  <>
                    <Button action="confirm" type="submit">
                      Confirmar
                    </Button>
                    <Button
                      action="cancel"
